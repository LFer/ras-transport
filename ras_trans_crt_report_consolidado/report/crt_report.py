...
class ParticularReport(models.AbstractModel):
    _name = 'report.ras_trans_crt_report_consolidado.report_crt_report'
    ...
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('ras_trans_crt_report_consolidado.report_crt_report')
