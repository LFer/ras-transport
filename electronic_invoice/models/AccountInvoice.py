...
class AccountInvoice(models.Model):
    ...
    # _sql_constraints = [
    #     ('number_unico', 'unique(number, company_id, journal_id, type)', 'Invoice Number must be unique per Company!'),
    # ]
    ...
    internal_number = fields.Char(string='Numero Interno de Odoo')
    ...
    def update_document_number(self):
        ...
        number = ''
        if self.fe_Serie and self.fe_DocNro:
            number = str(self.fe_Serie + '-' + str(self.fe_DocNro))
        self.internal_number = internal_number
        self.move_id.name = number
    ...
    def action_invoice_open(self):
        ...
        #NO FIRMAMOS FACTURAS DE PROVEEDOR
